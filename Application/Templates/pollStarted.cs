                                                                    ...
                                                                    <td style='padding-top:20px;padding-bottom:20px;'>
                                                                        <div style='font-family: sans-serif'>
                                                                            <div class='txtTinyMce-wrapper' style='font-size: 12px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 21.6px; color: #1d1d1b; line-height: 1.8;'>
                                                                                <p style='margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 25.2px;'><span style='font-size:14px;'>➺ Voting ends by: {{VotingEndDate}}<br /><span style='font-size:14px;'>➺ Poll type: {{PollType}}<br /></span><br /><span style='font-size:14px;'>➺ Results are {{ResultsPublicity}}<br /></span><br /><span style='font-size:14px;'>➺ Voting token: {{VotingToken}}</span></p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
