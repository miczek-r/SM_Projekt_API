...
namespace Application.Templates
{
    public class PollEndedTemplate
    {
		...
		<h1 style='margin: 0; color: #f2663f; direction: ltr; font-family: 'Playfair Display', Georgia, serif; font-size: 39px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;'><span class='tinyMce-placeholder'>The poll has ended</span></h1>
		</td>
		</tr>
		</table>
		</td>
		...
		<tbody>
		<tr>
		<td class='column column-1' style='mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-left: 50px; padding-right: 50px; padding-top: 20px; padding-bottom: 20px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;' width='100%'>
		<table border='0' cellpadding='0' cellspacing='0' class='text_block' role='presentation' style='mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;' width='100%'>
		<tr>
		<td>
		<div style='font-family: sans-serif'>
		<div class='txtTinyMce-wrapper' style='font-size: 12px; mso-line-height-alt: 18px; color: #1d1d1b; line-height: 1.5; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;'>
		<p style='margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 42px;'><span style='font-size:28px;'>The poll {{PollName}} has ended</span></p>
		</div>
		</div>
		</td>
		</tr>
